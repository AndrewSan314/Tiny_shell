...
int msh_help(char **args) {
  ...
  printf("  ai <message>       ");
  reset_color();
  printf("Chat with AI (remembers context)\n");
  set_color(CLR_BRIGHT_CYAN);
  printf("  ai clear           ");
  reset_color();
  printf("Clear conversation history\n");
  set_color(CLR_BRIGHT_CYAN);
  printf("  ai history         ");
  reset_color();
  printf("Show conversation history\n");
  set_color(CLR_BRIGHT_CYAN);
  printf("  ai system <prompt> ");
  reset_color();
  printf("Set custom AI system prompt\n");
  set_color(CLR_BRIGHT_CYAN);
  printf("  !<command>         ");
  reset_color();
